    ...
    <div class="left-sidebar pull-left">
        ...
        <div class="information">
            <div class="btn-group btn-group-justified">
                <?php echo CHtml::link('Followers:'. $user->followeesCount, $this->createUrl('user/followers/', (Yii::app()->user->id == $id) ? array() : array('id' => $id)), array('class' => 'btn btn-primary')); ?>
                <?php echo CHtml::link('Following:'. $user->followersCount, $this->createUrl('user/following/', (Yii::app()->user->id == $id) ? array() : array('id' => $id)), array('class' => 'btn btn-primary')); ?>
                <?php echo CHtml::link('Shares:'. $user->sharesCount, $this->createUrl('user/shares/', (Yii::app()->user->id == $id) ? array() : array('id' => $id)), array('class' => 'btn btn-primary')); ?>
                <!--
                <a type="button" class="btn btn-primary" >Followers: --><?php //echo $user->followeesCount; ?><!--</a>
                <a type="button" class="btn btn-primary" >Following: <?php// echo $user->followersCount; ?></a>
                <a type="button" class="btn btn-primary" >Shares: <span class="share-count"><?php// echo $user->sharesCount; ?></span></a>
                -->
            </div>
        </div>
    </div>
